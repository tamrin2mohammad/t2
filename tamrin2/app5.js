...
let sortedData = filteredData.sort(function(a,b){
    return parseFloat(a.money.slice(1)) - parseFloat(b.money.slice(1));
});

let finalData = sortedData.map(function(element){
    return {firstName: element.firstName, money: element.money};
});
