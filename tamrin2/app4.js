...
const result = data
 ...
 .filter(element => element.money.replace('$','') > 1500 && element.country === "United States")

.map(element => ({ firstName: element.firstName, money: element.money , country: element.country}));
