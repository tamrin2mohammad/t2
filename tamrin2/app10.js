...
const IranCO = data.filter(element => element.country === "Iran");

const result = IranCO.map(element => ({ firstName: element.firstName, lastName: element.lastName, country: element.country}));
